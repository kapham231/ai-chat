    ...
    return (
        <div className="w-80 bg-slate-900 text-slate-300 p-4 flex flex-col h-full shadow-2xl z-20">
            <div className="flex items-center gap-3 mb-8 px-2">
                ...
                <h1 className="text-xl font-bold text-white tracking-tight flex-1">
                    AI Chat
                </h1>
            ...
            <div className="flex-1 overflow-y-auto space-y-1 pr-2 custom-scrollbar">
                ...
                {conversations.map((conversation) => (
                    <div
                        ...
                        className={`p-3.5 rounded-xl cursor-pointer flex items-center group transition-all duration-200 border ${selectedConversation?._id ===
                            conversation._id
                    ...
                    >
                        ...
                        <button
                            ...
                            className={`p-1.5 rounded-lg transition-all flex-shrink-0 ${selectedConversation?._id === conversation._id
